...
| 日期 | 计划 | 状态 | 验收摘要 |
| --- | --- | --- | --- |
| 2026-07-20 | [Windows 单人免安装便携交付](2026-07-20_windows-portable-release_plan.md) | 已完成 | 免 Python、一键后台启停、当前配置原样带入；98 项测试与冻结 EXE 验证通过。 |
...
| 2026-07-20 | [汇总结果自动隐藏黄色/橙色数据行](2026-07-20_yellow-signing-row-hiding_plan.md) | 已完成 | C:G 任一暖色字段触发隐藏，非关键列颜色不误判；95 项测试通过。 |
